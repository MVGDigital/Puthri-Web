  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/swiperslider.min.css">
        ...
        <div class="row">
          <div class="col-12 mt-3">
            <div class="navigation-section">
              ...
              <a href="pcca.php" class="navigation-links"><h5>PCCA</h5></a>
                        </div>
          </div>
        </div>
      </div>
      ...
      <section class="main-container">
          ...
          <div class="row d-flex img-txt container p-10">
              ...
              <div class="mitr-banner col-lg-6 p-10">
          ...
          <div class="ahtc-card-title p-10 mt-60 mb-30">
            <h6>#COMPONENTS</h6>
